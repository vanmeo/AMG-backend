...
namespace AMGAPI.Services.Base
{
    public interface IDangkykenh_DuyetRepository
    {
        ...
        List<Dangkykenh_Duyet> FindAll(string searchString, string IdDonvi, DateTime from, DateTime to);
        PagedList<Dangkykenh_Duyet> findAll(PaginParameters paginParameters, string searchString, string IdDonvi, DateTime from, DateTime to);
